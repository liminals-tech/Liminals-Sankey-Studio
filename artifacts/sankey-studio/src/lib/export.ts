...
export function modelToSvg(model: SankeyModel, options: SankeyExportOptions) {
  ...
  const backgroundImage = options.backgroundImage ? `<image href="${escapeXml(options.backgroundImage)}" x="0" y="0" width="1000" height="560" preserveAspectRatio="xMidYMid slice" opacity=".16"/>` : "";
