...
type Props = { onImport: () => void; onExport: () => void; onHelp: () => void; onMenu: () => void; onInspector: () => void; dataOpen: boolean; inspectorOpen: boolean };

export function TopBar({ onImport, onExport, onHelp, onMenu, onInspector, dataOpen, inspectorOpen }: Props) {
  return (
