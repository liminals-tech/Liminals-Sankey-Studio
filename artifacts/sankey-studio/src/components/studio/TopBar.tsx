...
type Props = { onImport: () => void; onExport: () => void; onHelp: () => void; onMenu: () => void; onInspector: () => void; onSignIn: () => void; onSignUp: () => void; dataOpen: boolean; inspectorOpen: boolean };

export function TopBar({ onImport, onExport, onHelp, onMenu, onInspector, onSignIn, onSignUp, dataOpen, inspectorOpen }: Props) {
  return (
