  ...
  return (
    <header className="flex h-[67px] shrink-0 items-center justify-between border-b border-[hsl(var(--border))] bg-[hsl(var(--background)/.92)] px-4 backdrop-blur-md sm:px-7">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        <button onClick={onInspector} className="grid size-9 place-items-center rounded-md text-[hsl(var(--muted-foreground))] transition hover:bg-[hsl(var(--muted))] hover:text-[hsl(var(--foreground))]" aria-label={inspectorOpen ? "Collapse editor menu" : "Expand editor menu"} data-testid="button-toggle-inspector"><PanelRight size={17} /></button>
