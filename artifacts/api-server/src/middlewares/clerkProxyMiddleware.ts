 ...
 *
 * The proxy is production-only. It lets the published app load Clerk's
 * browser SDK through the app's own domain while development talks directly
 * to Clerk's development Frontend API.
 */
